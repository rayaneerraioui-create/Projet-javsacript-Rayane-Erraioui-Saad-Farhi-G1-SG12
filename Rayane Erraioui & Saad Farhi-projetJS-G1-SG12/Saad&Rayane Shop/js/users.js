...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!stored || JSON.parse(stored).length <= 2) {
        const sampleUsers = [
            ...
            { id: 3, email: 'omar@example.com', password: 'pass123', name: 'omar marmoush', role: 'user', createdAt: new Date().toISOString() },
            { id: 4, email: 'leila@example.com', password: 'pass123', name: 'leila sabini', role: 'user', createdAt: new Date().toISOString() },
